 ...
 */
public class CorrecaoLivroFisico extends CorrecaoItemBiblioteca {
     ...
     */
    public CorrecaoLivroFisico(String titulo, String autor, int anoPublicacao, int numeroPaginas) {
