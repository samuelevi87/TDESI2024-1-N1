 ...
 */
public class CorrecaoCartaoCredito extends CorrecaoFormaPagamento {
     ...
     */
    public CorrecaoCartaoCredito(String nome, double taxaTransacao, String numeroCartao, String bandeira) {
