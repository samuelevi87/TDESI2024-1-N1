 ...
 * Estende a classe Funcionario e adiciona funcionalidades específicas para gerentes.
 */
public class CorrecaoGerente extends CorrecaoFuncionario {
     ...
     */
    public CorrecaoGerente(String nome, int identificador, double salarioBase, double bonusAnual) {
