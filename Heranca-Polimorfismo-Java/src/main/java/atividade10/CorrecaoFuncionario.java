...
/**
 * Classe abstrata base para representar um funcionário no sistema de gestão de RH.
 */
public abstract class CorrecaoFuncionario {
     ...
     */
    public CorrecaoFuncionario(String nome, String cpf, LocalDate dataAdmissao, double salarioBase) {
