 ...
 */
public class CorrecaoVendedor extends CorrecaoFuncionario {
     ...
     */
    public CorrecaoVendedor(String nome, String cpf, LocalDate dataAdmissao, double salarioBase, double comissao, double vendasMensais) {
