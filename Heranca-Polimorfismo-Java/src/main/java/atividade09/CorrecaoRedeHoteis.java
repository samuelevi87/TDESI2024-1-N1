 ...
 */
public class CorrecaoRedeHoteis {
    private List<CorrecaoHotel> listaDeHoteis;

    public CorrecaoRedeHoteis() {
     ...
     */
    public List<CorrecaoAcomodacao> buscarAcomodacoesDisponiveis() {
     ...
     * @return Uma lista de acomodações disponíveis em todos os hotéis.
     */
    public List<CorrecaoAcomodacao> buscarAcomodacoesDisponiveisSimples() {
