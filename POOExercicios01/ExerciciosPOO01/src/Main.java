...
public class Main {
    public static void main(String[] args) {
        ...
        ProdutoIndustrial produtoIndustrial = new ProdutoIndustrial("489","parafuso",0.25,1.00);
        // 2. Exibir o código, nome, preço de custo e preço de venda do produto.
        System.out.println("Nome: "+produtoIndustrial.getNome());
        System.out.println("Preço de custo: "+produtoIndustrial.getPrecoCusto());
        System.out.println("Preço de venda: "+produtoIndustrial.getPrecoVenda());
